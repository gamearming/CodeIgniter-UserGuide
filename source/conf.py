...
copyright = u'2014 - 2017, 遊戲武器開發網'
#copyright = u'2014 - 2017, 不列顛哥倫比亞理工學院'
...
html_title = u'CodeIgniter ' + release + u' 中文手冊|用戶手冊|用戶指南|中文文檔'
...
latex_documents = [
  ('index', 'CodeIgniter.tex', u'CodeIgniter 中文手冊',
   ur'\hfill 不列顛哥倫比亞理工學院\\CodeIgniter 中國開發者社區', 'manual'),
]

# 如果在文檔中有中文，使用這種方法產生 pdf 的話 pdflatex 會提示錯誤。
# 要解決這個問題，需要修改conf.py中的乳膠配置，在生成的乳膠文件中添加對中文的支持。在conf.py中找到latex_elements並修改為如下：
latex_elements = {
...
man_pages = [
    ('index', 'codeigniter', u'CodeIgniter 文檔',
     [u'不列顛哥倫比亞理工學院'], 1)
]
...
epub_author = u'不列顛哥倫比亞理工學院'
epub_publisher = u'不列顛哥倫比亞理工學院'
epub_copyright = u'2014 - 2017, 不列顛哥倫比亞理工學院'
